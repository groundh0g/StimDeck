...
permalink: /docs/downloads/developers/xx/
...
{% capture text %}
If you're looking for the StimDeck source code, you're in the right place.
{% endcapture %}
{{ text | markdownify }}
</div>
...
<div class="download-heading">For Supporters</div>
<div class="download-heading-text">
...
<div class="download-heading-text">
<p>If you're looking for the StimDeck application, you're in the right place. StimDeck is a heads up display (HUD) for the <a href="">Stimulus.com social media site</a>. If you've ever used the HUD for <a href="https://tweetdeck.twitter.com/">the blue-bird site</a>, then you'll already know how things work. If you need a little more guidance, check out the <a href="{{site.baseurl}}/docs/user-guide/">User Documentation</a>.</p>
</div>
